...
function showText(icon, lng, lat, title, hover_title, content){
    ...
    var infoWindow_baiyun = new BMapGL.InfoWindow(content, opts_baiyun);  // 创建信息窗口对象
    var point_baiyun= new BMapGL.Point(lng,lat);
    var icon_jichang = new BMapGL.Icon(icon, new BMapGL.Size(24, 24), { anchor: new BMapGL.Size(24, 24) });
...
var house = "data:image/png;base64,";
