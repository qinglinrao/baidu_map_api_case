 ...
 * 用户可以在地图上自定义轨迹运动
 * 可以自定义路过某个点的图片，文字介绍等。
 * 主入口类是<a href="symbols/BMapGLLib.LuShu.html">LuShu</a>，
 * 基于Baidu Map API 1.2。.
 *
...
(function () {
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _addMarker: function (callback) {
            ...
            this._marker = marker;
            // 变更
            // var markerL = new BMapGL.Marker(this._path[0], { left: true });
            ...
            // var markerR = new BMapGL.Marker(this._path[0], { right: true });
    ...
    function calcGreatCirclePath(latLng1, latLng2) {
        // console.log('calcGreatCirclePoints', latLng1, latLng2);
        ...
        // console.log('count', count, distance);
        var angularDistance = calcAngularDistance(latLng1, latLng2);
        // this.greatCirclePoints.push(this.points[0][0]);
        result.push(latLng1);
